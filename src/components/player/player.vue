    ...
    <div class="player"  v-show="playList.length>0">
                ...
                <div class="bottom">
                    <div class="progress-wrapper">
                        ...
                        <div class="progress-bar-wrapper">
                            <progress-bar :percent="percent" @perChange="onprobarChange"></progress-bar>
                        </div>
        ...
        <transition name="mini">
         <div class="mini-player" v-show="!fullScreen" @click="open">
            <div class="icon">
                <img  :class="cdClass" width="40" height="40" alt="" :src="currentSong.image">
            </div>
            <div class="text">
            ...
            <div class="control">
                <mini-progress :radius="radius" :percent="percent">
...
import MiniProgress from '../../base/miniprogress/miniprogress'
...
export default {
  ...
  methods: {
      ...
      onprobarChange(per){
          this.$refs.audioDom.currentTime=this.currentSong.duration*per
          if(!this.playing){
              this.togglePlaying()
          }
      },
    ...
    ...mapMutations({
      setFullScreen: "SET_FULL_SCREE",
      setPlayingState:"SET_PLAYING",
      setCurrentIndex:"SET_CURRENT_INDEX",
      setPlayMode:"SET_PLAY_MODE",
      setPlauList:"SET_PLAYLIST"
    }),
    enter(el,done){
